 ...
 * @param <T>
 */
public class Q4DequeSolved<T> extends Deque<T>{

    Q4DequeSolved() {
        super();
    }

    Q4DequeSolved(Sentinel<T> header) {
        super(header);
    }
     ...
     */
    void append(Q4DequeSolved<T> other) {
...
class ExamplesDeques {
    Q4DequeSolved<String> deque1;
    Q4DequeSolved<String> deque2;
    Q4DequeSolved<String> deque3;

    boolean initData(Tester t) {
        try {
            this.deque1 = new Q4DequeSolved<String>();
            ...
            this.deque2 = new Q4DequeSolved<String>(sortedHeader);
            ...
            this.deque3 = new Q4DequeSolved<String>(unsortedHeader);
            return true;
        } catch (Exception e) {
